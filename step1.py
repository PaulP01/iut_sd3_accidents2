...
df_veh = pd.read_csv('data/veh.csv', sep=";") 
df_vict = pd.read_csv('data/vict.csv', sep=";") 
df_lieux = pd.read_csv('data/lieux.csv', sep=";") 
df_carac = pd.read_csv('data/carac.csv', sep=";") 
